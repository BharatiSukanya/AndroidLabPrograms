package com.example.sms_dialer_email;
...
public class MainActivity extends AppCompatActivity {
    private static final int MY_PERMISSIONS_REQUESTS_SEND_SMS =0;
    Button sendBtn;
    Button btnSendEmail;
    Button btnPhone;
    String phoneNo;
    ...
    protected void sendEmail() {
        ...
        emailIntent.putExtra(Intent.EXTRA_EMAIL,new String[]{"sukanya.bharati@gail.com"});
